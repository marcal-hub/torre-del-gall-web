...
- 2026-09-22: Per owner (visual edit): bosquet ceremony photo moved from Espais filter → Bodes filter (label "Cerimònia"/"Ceremonia"/"Ceremony"). Bodes filter now has 2 (olive-grove couple + bosquet); Espais has 2 (sala + mirador).
